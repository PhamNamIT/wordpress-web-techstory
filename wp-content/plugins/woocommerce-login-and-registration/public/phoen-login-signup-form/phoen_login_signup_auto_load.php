        ...
        <div class="form">
            <form id="js_phoen_login_popup">
                ...
                <div class="form-element">
                    ...
                    <input id="wp_http_referer" type="hidden" name="_wp_http_referer" value="<?php echo get_site_url(); ?>/tai-khoan/">    
                </div>
                ...
                <?php if(get_option('_lsphe_enable_tncond') == 'on'): ?>
                    ...
                    <p class="form-row" style="display:inline-flex;">
                        ...
                        <label for="remember-me">Bằng cách tạo một tài khoản, bạn đồng ý với 
                        <a  href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'Điều khoản & Điều kiện', 'phoen_login_signup' ); ?></a> của chúng tôi</label>
                    </p>
                <?php endif; ?>
                ...
                <div class="form-element">
                 ...
                 <div class="form-element">
                    <a style="color: <?php _e($forget_password_label_color) ?>;" href="<?php echo get_site_url(); ?>/tai-khoan/quen-mat-khau/"><?= _e($forget_password_link_label)?></a>
                </div>
            </form>
        </div>
    </div>
