		            ...
		            <form id="js_phoen_login_popup">
		                ...
		                <div class="form-element">
		                 ...
		                 <div class="form-element">
		                    ...
		                    <a class="forget_password" style="color: <?php _e($forget_password_label_color) ?>;" href="<?php echo get_site_url(); ?>/tai-khoan/quen-mat-khau/"><?= _e($forget_password_link_label)?></a>
		                </div>
