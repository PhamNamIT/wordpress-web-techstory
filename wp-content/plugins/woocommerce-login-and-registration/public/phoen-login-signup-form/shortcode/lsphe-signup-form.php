	...
	<div class="col-set" id="customer_login">
		...
		<div class="col">
			...
			<form method="post" class="register">	
				...
				<p class="form-row">
					<input type="hidden" id="_wpnonce" name="_wpnonce" value="70c2c9e9dd"><input type="hidden" name="_wp_http_referer" value="<?php echo get_site_url(); ?>/tai-khoan/">				
